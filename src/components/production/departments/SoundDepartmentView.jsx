...
function SoundDepartmentView({ production, onUpdateScene, userRole }) {
  ...
  const tabNav = React.createElement(
    ...
    React.createElement('button', { onClick: () => setActiveTab('ghost_light'), style: { padding: '6px 12px', fontSize: '14px', fontWeight: '500', borderRadius: '6px', border: 'none', cursor: 'pointer', background: '#5b21b6', marginBottom: '-2px' } }, React.createElement('img', { src: 'assets/ghostlight/ghostlight-button.png', alt: 'GhostLight', style: { height: '22px', objectFit: 'contain' } }))
  );
